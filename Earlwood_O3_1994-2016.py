...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 10 16:48:27 2018
...
#Plotting Chullora with a latitude of -33.91777778 and a longtitude of 151.03472222
spei = dataset.spei

spei_site = spei.sel(lat=-33.91777778,lon=151.03472222,method='nearest')
...
df['EARLWOOD'] = df['EARLWOOD']*10.0


for i in range (1,13): 
    rolling = df[['EARLWOOD']][df.mon==i].rolling(window = 7, center=True)

    rolling_mean = rolling.mean()
    
    
    anomoly = (df['EARLWOOD'][df.mon==i]) - rolling_mean['EARLWOOD']
