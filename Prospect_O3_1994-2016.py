...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan 11 12:02:55 2018
...
#Plotting Prospect with a latitude of -33.79472222 and a longtitude of 150.9125
spei = dataset.spei

spei_site = spei.sel(lat=-33.79472222,lon=150.9125,method='nearest')
...
df['PROSPECT '] = df['PROSPECT ']*10.0


for i in range (1,13): 
    rolling = df[['PROSPECT ']][df.mon==i].rolling(window = 7, center=True)

    rolling_mean = rolling.mean()
    
    
    anomoly = (df['PROSPECT '][df.mon==i]) - rolling_mean['PROSPECT ']
