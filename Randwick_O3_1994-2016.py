...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan 11 14:38:47 2018
...
#Plotting RANDWICK with a latitude of -33.933333333333 and a longtitude of 151.24194444444
spei = dataset.spei

spei_site = spei.sel(lat=-33.933333333333,lon=151.24194444444,method='nearest')
...
df['RANDWICK '] = df['RANDWICK ']*10.0

for i in range (1,13): 
    rolling = df[['RANDWICK ']][df.mon==i].rolling(window = 7, center=True)

    rolling_mean = rolling.mean()
    
    
    anomoly = (df['RANDWICK '][df.mon==i]) - rolling_mean['RANDWICK ']
