...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb 13 13:31:48 2018
...
spei_site = spei.sel(lat=-34.80,lon=138.49,method='nearest')
...
#Read the file
df = read_csv('/home/emma/Documents/LeFevre Primary_PM10_2005-2017.csv')
...
#spei_site.plot(label='SPEI', color='royalblue', ax=ax1)

#al1.plot(label='Anomaly', color='darkorange', ax=ax2)
ax1 = spei_site.plot(label='SPEI', color='royalblue')
ax2 = al1.plot(label='Anomaly', color='darkorange')
plt.ylim(-1.5,1.5)

#ax1.set_ylim([-1.5, 1.5])
ax1.set_xlabel('Date')
ax1.set_ylabel('SPEI', color='royalblue')
ax2.set_ylabel('Anomaly', color='darkorange')


pyplot.grid(True)
pyplot.legend(loc='best')
pyplot.title('LeFevre_PM10')
#pyplot.savefig("LeFerve.png")
pyplot.show()
