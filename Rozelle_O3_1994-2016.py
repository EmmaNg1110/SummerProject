...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan 11 12:05:06 2018
...
#Plotting Rozelle with a latitude of -33.86583333 and a longtitude of 151.1625
spei = dataset.spei

spei_site = spei.sel(lat=-33.86583333,lon=151.1625,method='nearest')
...
df['ROZELLE '] = df['ROZELLE ']*10.0


for i in range (1,13): 
    rolling = df[['ROZELLE ']][df.mon==i].rolling(window = 7, center=True)

    rolling_mean = rolling.mean()
    
    
    anomoly = (df['ROZELLE '][df.mon==i]) - rolling_mean['ROZELLE ']
