...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 10 16:52:49 2018
...
df['LIVERPOOL'] = df['LIVERPOOL']*10.0


for i in range (1,13): 
    rolling = df[['LIVERPOOL']][df.mon==i].rolling(window = 7, center=True)

    rolling_mean = rolling.mean()
    
    
    anomoly = (df['LIVERPOOL'][df.mon==i]) - rolling_mean['LIVERPOOL']
