...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan 11 12:18:54 2018
...
#Plotting NEWCASTLE with a latitude of -32.9325 and a longtitude of 151.75833333333
spei = dataset.spei

spei_site = spei.sel(lat=-32.9325,lon=151.75833333333,method='nearest')
...
df['NEWCASTLE'] = df['NEWCASTLE']*10.0


for i in range (1,13): 
    rolling = df[['NEWCASTLE']][df.mon==i].rolling(window = 7, center=True)

    rolling_mean = rolling.mean()
    
    
    anomoly = (df['NEWCASTLE'][df.mon==i]) - rolling_mean['NEWCASTLE']
