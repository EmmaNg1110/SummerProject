...
# -*- coding: utf-8 -*-
"""
Created on Fri Jan 12 14:29:46 2018
...
spei_site = spei.sel(lat=-33.93277778,lon=150.90583333,method='nearest')
...
#Read the file
data = read_csv('/home/emma/Downloads/tmp_table_PM10_011996-012016.csv')
...
for i in range (1,13): 
    rolling = data[['LIVERPOOL']][data.mon==i].rolling(window = 7, center=True)

    rolling_mean = rolling.mean()
    
    
    anomoly = (data['LIVERPOOL'][data.mon==i]) - rolling_mean['LIVERPOOL']
