...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan 11 12:11:26 2018
...
#Plotting WALLSEND with a latitude of -32.896111111111 and a longtitude of 151.66916666667
spei = dataset.spei

spei_site = spei.sel(lat=-32.896111111111,lon=151.66916666667,method='nearest')
...
df['WALLSEND'] = df['WALLSEND']*10.0


for i in range (1,13): 
    rolling = df[['WALLSEND']][df.mon==i].rolling(window = 7, center=True)

    rolling_mean = rolling.mean()
    
    
    anomoly = (df['WALLSEND'][df.mon==i]) - rolling_mean['WALLSEND']
