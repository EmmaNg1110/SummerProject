...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan 11 15:11:20 2018
...
#Plotting ALBION PARK STHwith a latitude of -34.580555555556 and a longtitude of 150.78166666667
spei = dataset.spei

spei_site = spei.sel(lat=-34.580555555556,lon=150.78166666667,method='nearest')
...
df['ALBION PARK STH '] = df['ALBION PARK STH ']*10.0


for i in range (1,13): 
    rolling = df[['ALBION PARK STH ']][df.mon==i].rolling(window = 3, center=True)

    rolling_mean = rolling.mean()
    
    
    anomoly = (df['ALBION PARK STH '][df.mon==i]) - rolling_mean['ALBION PARK STH ']
...
pyplot.title('ALBION PARK STH_O3')
pyplot.show()
