...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan 25 14:52:16 2018
...
#Plotting Bunbury with a latitude of -33.3416 and a longtitude of 115.6433
spei = dataset.spei
...
for i in range (1,13): 
    rolling = new1[['PM10']][new1.mon==i].rolling(window = 5, center=True)
