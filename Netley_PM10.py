...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb 13 14:50:06 2018
...
spei_site = spei.sel(lat=-34.94527778,lon=138.55055556,method='nearest')
...
#Read the file
df = read_csv('/home/emma/Documents/SA/Netley_PM10_2005-2017.csv')
...
for i in range (1,13): 
    rolling = new[['PM10 ']][new.mon==i].rolling(window = 7, center=True)
