...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 10 16:43:14 2018
...
#Plotting Chullora with a latitude of -33.89388889 and a longtitude of 151.04527778
spei = dataset.spei

spei_site = spei.sel(lat=-33.89388889,lon=151.04527778,method='nearest')
...
df['CHULLORA '] = df['CHULLORA ']*10.0


for i in range (1,13): 
    rolling = df[['CHULLORA ']][df.mon==i].rolling(window = 7, center=True)

    rolling_mean = rolling.mean()
    
    
    anomoly = (df['CHULLORA '][df.mon==i]) - rolling_mean['CHULLORA ']
