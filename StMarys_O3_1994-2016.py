...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan 11 15:06:34 2018
...
#Plotting ST MARYSwith a latitude of --34.476388888889 and a longtitude of 150.8175
spei = dataset.spei

spei_site = spei.sel(lat=-33.797222222222,lon=150.8175,method='nearest')
...
df['ST MARYS'] = df['ST MARYS']*10.0


for i in range (1,13): 
    rolling = df[['ST MARYS']][df.mon==i].rolling(window = 7, center=True)

    rolling_mean = rolling.mean()
    
    
    anomoly = (df['ST MARYS'][df.mon==i]) - rolling_mean['ST MARYS']
