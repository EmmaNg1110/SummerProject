...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 10 17:07:10 2018
...
df['LINDFIELD '] = df['LINDFIELD ']*10.0


for i in range (1,13): 
    rolling = df[['LINDFIELD ']][df.mon==i].rolling(window = 7, center=True)

    rolling_mean = rolling.mean()
    
    
    anomoly = (df['LINDFIELD '][df.mon==i]) - rolling_mean['LINDFIELD ']
