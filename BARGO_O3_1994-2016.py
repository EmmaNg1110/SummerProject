...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 10 15:44:36 2018
...
spei_site = spei.sel(lat=-34.3075,lon=150.58,method='nearest')
...
df['BARGO '] = df['BARGO ']*10.0


for i in range (1,13): 
    rolling = df[['BARGO ']][df.mon==i].rolling(window = 7, center=True)

    rolling_mean = rolling.mean()
    
    
    anomoly = (df['BARGO '][df.mon==i]) - rolling_mean['BARGO ']
