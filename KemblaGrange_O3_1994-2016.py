...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan 11 14:54:09 2018
...
#Plotting KEMBLA GRANGEwith a latitude of --34.476388888889 and a longtitude of 150.8175
spei = dataset.spei

spei_site = spei.sel(lat=-34.476388888889,lon=150.8175,method='nearest')
...
df['KEMBLA GRANGE'] = df['KEMBLA GRANGE']*10.0


for i in range (1,13): 
    rolling = df[['KEMBLA GRANGE']][df.mon==i].rolling(window = 7, center=True)

    rolling_mean = rolling.mean()
    
    
    anomoly = (df['KEMBLA GRANGE'][df.mon==i]) - rolling_mean['KEMBLA GRANGE']
