...
Bargo = df['BARGO']
Liv = df['LIVERPOOL']
Bringelly = df['BRINGELLY']
Chullora = df['CHULLORA']
Earlwood = df['EARLWOOD']
KemGr = df['KEMBLA GRANGE']
#Lindfield = df['LINDFIELD']*10.0
#Newcastle = df['NEWCASTLE']*10.0
#Oakdale = df['OAKDALE']*10.0
Prospect = df['PROSPECT ']
Randwick = df['RANDWICK']
Rozelle = df['ROZELLE']
StMarys = df['ST MARYS']
Wallsend = df['WALLSEND']
...
#normal8 = result8[result2['spei'].between(-0.5, 0.5, inclusive=True)]
#normal10 = result10[result2['spei'].between(-0.5, 0.5, inclusive=True)]
normal11 = result11[result11['spei'].between(-0.5, 0.5, inclusive=True)]
normal12 = result12[result12['spei'].between(-0.5, 0.5, inclusive=True)]
...
normal15 = result15[result15['spei'].between(-0.5, 0.5, inclusive=True)]



to_plot1 = drought2.append([drought3, drought4, drought5, drought6, drought7, drought11, drought12, drought13, drought14, drought15], ignore_index=True)

to_plot2 = to_plot1["BARGO"].append([to_plot1["LIVERPOOL"], to_plot1["BRINGELLY"], to_plot1["CHULLORA"], to_plot1["EARLWOOD"], to_plot1["KEMBLA GRANGE"], to_plot1["PROSPECT "], to_plot1["RANDWICK"], to_plot1["ROZELLE"], to_plot1["ST MARYS"], to_plot1["WALLSEND"]])


to_plot3 = normal2.append([normal3, normal4, normal5, normal6, normal7, normal11, normal12, normal13, normal14, normal15], ignore_index=True)

to_plot4 = to_plot3["BARGO"].append([to_plot3["LIVERPOOL"], to_plot3["BRINGELLY"], to_plot3["CHULLORA"], to_plot3["EARLWOOD"], to_plot3["KEMBLA GRANGE"], to_plot3["PROSPECT "], to_plot3["RANDWICK"], to_plot3["ROZELLE"], to_plot3["ST MARYS"], to_plot3["WALLSEND"]])


to_plot5 = wet2.append([wet3, wet4, wet5, wet6, wet7,wet11, wet12, wet13, wet14, wet15], ignore_index=True)

to_plot6 = to_plot5["BARGO"].append([to_plot5["LIVERPOOL"], to_plot5["BRINGELLY"], to_plot5["CHULLORA"], to_plot5["EARLWOOD"], to_plot5["KEMBLA GRANGE"], to_plot5["PROSPECT "], to_plot5["RANDWICK"], to_plot5["ROZELLE"], to_plot5["ST MARYS"], to_plot5["WALLSEND"]])
