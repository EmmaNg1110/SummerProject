...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan 25 14:48:50 2018
...
#Plotting Bunbury with a latitude of -34.3075 and a longtitude of 150.58
spei = dataset.spei

spei_site = spei.sel(lat=-33.3416,lon=115.6433,method='nearest')
...
#Read the file
file_new = '/home/emma/Downloads/bun11.csv'
...
df2 = read_csv('/home/emma/Downloads/bun96.csv')
...
data['PM2.5'] = data['PM2.5'].convert_objects(convert_numeric=True)
